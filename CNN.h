...
float *FORWARD_PASS(Tensor *tensor, float *filter_1, float *filter_2, float *filter_3, float *displacement, int size_ker, int row_filter_1, int col_filter_1, int *res_size, float *loss); 
